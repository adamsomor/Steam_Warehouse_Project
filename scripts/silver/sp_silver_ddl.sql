...
====================================================
To execute run:
		CALL silver.rebuild_all_tables();
		
====================================================
It drops and then creates tables in 'silver' schema

====================================================
*/


CREATE OR REPLACE PROCEDURE silver.rebuild_all_tables(
	)
LANGUAGE 'plpgsql'
AS $BODY$
BEGIN
...
CREATE TABLE IF NOT EXISTS silver.game_review_stats (
    id                       BIGINT PRIMARY KEY DEFAULT nextval('silver.game_review_stats_id_seq'),
...
CREATE TABLE IF NOT EXISTS silver.game_reviews (
    id                   BIGINT PRIMARY KEY DEFAULT nextval('silver.game_reviews_id_seq'),
