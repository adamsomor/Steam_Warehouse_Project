...
It loads data from the table
		'bronze.steam_app_details'
			into silver.dim_rating_agencies
====================================================
*/

CREATE OR REPLACE PROCEDURE silver.load_dim_rating()
LANGUAGE plpgsql
AS $BODY$
DECLARE
...
BEGIN
    RAISE NOTICE '================================================';
    RAISE NOTICE 'Loading Silver Layer: dim_rating_agencies';
    RAISE NOTICE '================================================';
    ...
    INSERT INTO silver.dim_rating_agencies (agency_code)
