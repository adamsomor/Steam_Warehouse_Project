...
It loads data from the table
		'bronze.steam_app_details'
			into silver.dim_categories
====================================================
*/

CREATE OR REPLACE PROCEDURE silver.load_dim_categories()
LANGUAGE plpgsql
AS $BODY$
DECLARE
...
BEGIN
    RAISE NOTICE '================================================';
    RAISE NOTICE 'Loading Silver Layer: dim_categories';
    RAISE NOTICE '================================================';
	...
	INSERT INTO silver.dim_categories (category_id, category_description)
	WITH all_cats AS (
	  SELECT
